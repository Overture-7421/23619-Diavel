...
public PositionsTable positionsTable;
    ...
    public ExtendArmElevator (Arm arm, Elevator elevator, PositionsTable positionsTable){
        ...
        addCommands(
               ...
               new MoveArm(arm, positionsTable.getArmTarget(Index.getIndexValue())).withTimeout(1000),
               new WaitCommand(500),
               new ElevatorPositions(elevator, positionsTable.getElevatorTarget(Index.getIndexValue())).withTimeout(1000)
